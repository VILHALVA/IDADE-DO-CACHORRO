...
## DESCRIÇÃO:
O aplicativo "Calculadora de Idade de Cachorro" permite que os usuários calculem a idade de seus cachorros em "anos de cachorro". A premissa é baseada na crença popular de que cada ano de vida de um cachorro equivale a sete anos humanos. O aplicativo fornece uma interface simples e direta para realizar essa conversão.

## FUNCIONALIDADES:
1. **Entrada de Idade do Cachorro:**
   - O usuário pode inserir a idade do seu cachorro em anos através de um campo de texto numérico.

2. **Cálculo da Idade:**
   - Ao pressionar o botão "CALCULAR", o aplicativo calcula a idade do cachorro multiplicando a idade inserida por sete.

3. **Exibição do Resultado:**
   - O resultado do cálculo é exibido em um campo de texto abaixo do botão de cálculo, informando a idade do cachorro em anos humanos.
